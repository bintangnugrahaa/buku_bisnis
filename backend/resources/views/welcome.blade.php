...
<head>
    ...
    <title>{{ config('app.name', 'Buku Bisnis') }}</title>
    ...
    <div class="container">
        ...
        <div class="logo">
            <svg width="120" height="32" viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <!-- Book icon -->
                <rect x="2" y="6" width="20" height="20" rx="2" fill="#F59E0B" stroke="#D97706"
                    stroke-width="1" />
                <line x1="6" y1="10" x2="18" y2="10" stroke="white" stroke-width="1" />
                <line x1="6" y1="14" x2="18" y2="14" stroke="white" stroke-width="1" />
                <line x1="6" y1="18" x2="18" y2="18" stroke="white" stroke-width="1" />
                <line x1="6" y1="22" x2="14" y2="22" stroke="white" stroke-width="1" />

                <!-- Text -->
                <text x="28" y="20" font-family="Arial, sans-serif" font-size="14" font-weight="bold"
                    fill="#374151">Buku Bisnis</text>
            </svg>
        </div>

        <h1>Buku Bisnis</h1>
        <p class="subtitle">Sistem pembukuan dan manajemen keuangan modern untuk bisnis Indonesia</p>

        <div class="features">
            <div class="feature">
                <h3>📊 Dashboard Analitik</h3>
                <p>Lihat ringkasan finansial dengan kartu KPI yang dapat diklik dan widget interaktif</p>
            </div>
            <div class="feature">
                <h3>💰 Manajemen Akun</h3>
                <p>Kelola multiple akun (Kas, Bank, E-Wallet) dengan auto-formatting mata uang</p>
            </div>
            <div class="feature">
                <h3>🏷️ Kategori Hierarkis</h3>
                <p>Sistem kategori berlevel untuk organisasi data yang lebih baik</p>
            </div>
            <div class="feature">
                <h3>📝 Transaksi Lengkap</h3>
                <p>Catat pemasukan, pengeluaran, dan transfer dengan format Rupiah otomatis</p>
            </div>
            <div class="feature">
                <h3>👥 Multi-User</h3>
                <p>Setiap user memiliki data terpisah dengan keamanan terjamin</p>
            </div>
            <div class="feature">
                <h3>📱 Responsive Design</h3>
                <p>Antarmuka modern yang berfungsi sempurna di semua perangkat</p>
            </div>
        </div>

        <div style="margin-top: 2rem;">
            @auth
                <a href="{{ url('/admin') }}" class="btn">Buka Dashboard</a>
            @else
        ...
        <div
            style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 0.875rem;">
            <p>Dibuat dengan ❤️ menggunakan Laravel & Filament</p>
            <p style="margin-top: 0.5rem;">
                <a href="https://github.com/bintangnugrahaa" target="_blank" style="color: #f59e0b; text-decoration: none;">
                    @bintangnugrahaa
                </a>
            </p>
        </div>
